            ...
            <tbody>
                ...
                <?php foreach ($pengaduan as $pengaduan) : ?>
                    <tr>
                        ...
                        <td class="actions">
                            <?= $this->Html->link(__('View'), ['action' => 'view', $pengaduan->id], ['class' => 'btn btnxs btn-outline-primary', 'escape' => false]) ?>
                            <?= $this->Html->link(__('Edit'), ['action' => 'edit', $pengaduan->id], ['class' => 'btn btnxs btn-outline-primary', 'escape' => false]) ?>
